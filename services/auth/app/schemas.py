...
class UserResponse(BaseModel):
    ...
    vpn_private_key: Optional[str] = None
    vpn_internal_ip: Optional[str] = None
    vpn_config: Optional[str] = None
    vpn_config_file_id: Optional[str] = None
